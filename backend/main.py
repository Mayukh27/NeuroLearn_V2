...
from routers import (
    ...
    research_router,
    videos_router,             # ← V2 Phase 2: local video metadata
)
...
# V2 (Phase 4): the YouTube auto-discovery router is intentionally NOT
# registered — it scrapes YouTube to build course content, which V2
# removes entirely. All V2 content comes from the admin-only endpoints in
# courses_router/videos_router instead. The router/module itself
# (routers/content.py, scraping/) is left in place, unused, rather than
# deleted, to keep this change minimal and reversible.
# app.include_router(content_router)
app.include_router(crs_router)         # ← Phase 11 (NeuroLearn-MCL)
app.include_router(research_router)
app.include_router(videos_router)      # ← V2 Phase 2
