...
export const DUMMY_COURSES: Course[] = [
  {
    ...
    videoLinks: [
      { id: "v1", title: "What is React? — Introduction & Setup", url: "", duration: 720, thumbnail: "", order: 1, completed: true, watchedPercent: 100 },
      { id: "v2", title: "JSX & Components Deep Dive", url: "", duration: 890, thumbnail: "", order: 2, completed: true, watchedPercent: 100 },
      { id: "v3", title: "Props & Data Flow", url: "", duration: 650, thumbnail: "", order: 3, completed: true, watchedPercent: 100 },
      { id: "v4", title: "State & useState Hook", url: "", duration: 780, thumbnail: "", order: 4, completed: true, watchedPercent: 100 },
      { id: "v5", title: "useEffect & Side Effects", url: "", duration: 920, thumbnail: "", order: 5, completed: true, watchedPercent: 100 },
      { id: "v6", title: "Event Handling & Forms", url: "", duration: 640, thumbnail: "", order: 6, completed: false, watchedPercent: 35 },
      { id: "v7", title: "Conditional Rendering", url: "", duration: 540, thumbnail: "", order: 7, completed: false, watchedPercent: 0 },
      { id: "v8", title: "Lists & Keys", url: "", duration: 480, thumbnail: "", order: 8, completed: false, watchedPercent: 0 },
    ],
  },
  {
    id: "course_002",
    ...
    videoLinks: [
      { id: "v9", title: "Why State Management Matters", url: "", duration: 600, thumbnail: "", order: 1, completed: true, watchedPercent: 100 },
      { id: "v10", title: "Context API Fundamentals", url: "", duration: 750, thumbnail: "", order: 2, completed: true, watchedPercent: 100 },
      { id: "v11", title: "Redux Toolkit Setup", url: "", duration: 880, thumbnail: "", order: 3, completed: false, watchedPercent: 20 },
      { id: "v12", title: "Redux Thunk & Async", url: "", duration: 920, thumbnail: "", order: 4, completed: false, watchedPercent: 0 },
      { id: "v13", title: "Zustand — Lightweight Alternative", url: "", duration: 680, thumbnail: "", order: 5, completed: false, watchedPercent: 0 },
      { id: "v14", title: "State Architecture Patterns", url: "", duration: 700, thumbnail: "", order: 6, completed: false, watchedPercent: 0 },
    ],
  },
  {
    id: "course_003",
    ...
    videoLinks: [
      { id: "v15", title: "React Performance Basics", url: "", duration: 800, thumbnail: "", order: 1, completed: true, watchedPercent: 100 },
      { id: "v16", title: "React.memo & useMemo", url: "", duration: 700, thumbnail: "", order: 2, completed: false, watchedPercent: 40 },
      { id: "v17", title: "Code Splitting & Lazy Loading", url: "", duration: 650, thumbnail: "", order: 3, completed: false, watchedPercent: 0 },
      { id: "v18", title: "Profiler & DevTools", url: "", duration: 600, thumbnail: "", order: 4, completed: false, watchedPercent: 0 },
      { id: "v19", title: "Real-world Optimization Case Study", url: "", duration: 900, thumbnail: "", order: 5, completed: false, watchedPercent: 0 },
    ],
  },
  {
    id: "course_004",
    ...
    videoLinks: [
      { id: "v20", title: "Why TypeScript?", url: "", duration: 500, thumbnail: "", order: 1, completed: true, watchedPercent: 100 },
      { id: "v21", title: "Basic Types & Inference", url: "", duration: 620, thumbnail: "", order: 2, completed: true, watchedPercent: 100 },
      { id: "v22", title: "Interfaces & Type Aliases", url: "", duration: 580, thumbnail: "", order: 3, completed: true, watchedPercent: 100 },
      { id: "v23", title: "Functions & Generics", url: "", duration: 700, thumbnail: "", order: 4, completed: true, watchedPercent: 100 },
      { id: "v24", title: "Enums, Tuples & Utility Types", url: "", duration: 650, thumbnail: "", order: 5, completed: true, watchedPercent: 100 },
      { id: "v25", title: "TypeScript with React", url: "", duration: 780, thumbnail: "", order: 6, completed: true, watchedPercent: 100 },
      { id: "v26", title: "Advanced Patterns", url: "", duration: 850, thumbnail: "", order: 7, completed: false, watchedPercent: 15 },
    ],
  },
  {
    id: "course_005",
    ...
    tags: ["API", "REST", "HTTP"],
    videoLinks: [
      { id: "v27", title: "HTTP Fundamentals", url: "", duration: 620, thumbnail: "", order: 1, completed: true, watchedPercent: 100 },
      { id: "v28", title: "Fetch API & Promises", url: "", duration: 700, thumbnail: "", order: 2, completed: true, watchedPercent: 100 },
      { id: "v29", title: "Axios & Interceptors", url: "", duration: 680, thumbnail: "", order: 3, completed: true, watchedPercent: 100 },
      { id: "v30", title: "Error Handling Patterns", url: "", duration: 550, thumbnail: "", order: 4, completed: false, watchedPercent: 0 },
      { id: "v31", title: "Caching & SWR/React Query", url: "", duration: 800, thumbnail: "", order: 5, completed: false, watchedPercent: 0 },
      { id: "v32", title: "Authentication & JWT", url: "", duration: 900, thumbnail: "", order: 6, completed: false, watchedPercent: 0 },
    ],
  },
  {
    id: "course_006",
    ...
    videoLinks: [
      { id: "v33", title: "Web Security Overview", url: "", duration: 750, thumbnail: "", order: 1, completed: false, watchedPercent: 0 },
      { id: "v34", title: "Cross-Site Scripting (XSS)", url: "", duration: 680, thumbnail: "", order: 2, completed: false, watchedPercent: 0 },
      { id: "v35", title: "CSRF & CORS Deep Dive", url: "", duration: 700, thumbnail: "", order: 3, completed: false, watchedPercent: 0 },
      { id: "v36", title: "Content Security Policy", url: "", duration: 600, thumbnail: "", order: 4, completed: false, watchedPercent: 0 },
      { id: "v37", title: "Secure Coding Practices", url: "", duration: 850, thumbnail: "", order: 5, completed: false, watchedPercent: 0 },
    ],
  },
]
